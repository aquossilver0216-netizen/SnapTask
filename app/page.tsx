  ...
  useEffect(() => {
    const timer = window.setTimeout(() => {
      ...
      try {
        ...
        const savedWrong = JSON.parse(localStorage.getItem('snaptask-wrong-cards') ?? 'null'); if (Array.isArray(savedWrong)) setWrongIds(savedWrong.map(String));
